...
1. **[Unauthenticated User]**: Unauthenticated Users can interact with the map to get information about the weather conditions in their area...
...
3. **[Admin]**: Admins have the capacity to manage comments by removing or modifying unwanted comments.
...
- Martin Tang: Designed the architecture and design for the product (4.1 - 4.5).
- Miguel Menard:
