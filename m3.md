        ...
        3. **[Authenticated Users can enable notifications for extreme weather in their area]**:
            ...
            - **Failure scenario(s)**:
                 - 2a. Users decline to enable location services
                    - 2a1. A pop-up tells users location services are required to enable push notifications
                    - 2a2. Steps 7 and 8 are skipped.
                    - 2a3. A button to enable location services is now present in the Account page
        ...
        6. **[Admins can remove comments]**:
            ...
            - **Failure scenario(s)**:
                -6.a. Comment is not deleted
                    - 6a1. An error is returned saying "Failed to delete comment, please try again soon."
                git
...
**Database Schemas**
1. **AI DB**
    - **Purpose**: Used to store training, test, validation test split, and the model to fit future data
2. **Weather DB**
...
![Dependcy Diagram](documentation/images/4.5.png)


### **4.6. Functional Requirements Sequence Diagram**
1. [**Create User Account**](#fr1)
![Dependcy Diagram](documentation/images/CU_sequence.jpg)
2. [*User can Toggle between different Weather Events**](#fr1)
![Dependcy Diagram](documentation/images/TW_sequence.jpg)
3. [**User can comment on specific Weather Event**](#fr1)
![Dependcy Diagram](documentation/images/Com_sequence.jpg)
4. [**User can enable Weather Predictions**](#fr1)
![Dependcy Diagram](documentation/images/Predict_sequence.jpg)
5. [**Admin can Delete Comment**](#fr1)
![Dependcy Diagram](documentation/images/Del_sequence.jpg)
6. [**Users can Enable Push notifications**](#fr1)
![Dependcy Diagram](documentation/images/Notif_sequence.jpg)
