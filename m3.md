...
2. **[Admin]**: Admins can manage comments and weather pings. This includes deleting comments, editing pings, adding pings, etc.
    ...
    - **Detailed Flow for Each Independent Scenario**: 
        1. **[Account Creation and Authentication]**:
            ...
            - **Main success scenario**:
                ...
                5. Users are prompted to enable location services
                6. Users enable location services
                7. Users are prompted to enable push notifications
                8. Users enable push notifications
            - **Failure scenario(s)**:
                - 2a. ...
                    - 2a1. ...
                    - 2a2. ...
                - 6a. Users decline to enable location services
                ...
                - 8a. Users decline to enable push notifications
...
1. **[Notification Speed]**
    - **Description**: Users must receive notifications within 10 seconds of the information being available.
    - **Justification**: When dealing with a natural disaster, it is important that users have access to the information as soon as possible.
2. **[User Privacy]**
